...
<body>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        Email: <input type="email" name="mail" value="<?php echo $mail; ?>" onblur="checkEmail(this.value)"><span id="mailErr"><?php echo $mailErr; ?></span><br>
        Usuario: <input type="text" name="usuario" value="<?php echo $usuario; ?>" onblur="checkUser(this.value)"><span id="usuarioErr"><?php echo $usuarioErr; ?></span><br>
